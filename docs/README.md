# Assurance and operations index
...
- `research-governance.md`: dataset, model, experiment, and change controls.
- `evidence/design-qa/`: matched source/implementation screenshots supporting the root `design-qa.md` report.
- `runbooks/`: deployment, incident, and restoration procedures.

Update these artefacts in the same pull request as any affected requirement, boundary, risk, provider, policy, or model.
